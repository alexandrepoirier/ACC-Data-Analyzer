...
À faire:
    - Coder un petit script qui vérifie que les dossiers temporaire ne
      s'accumulent pas s'il y a des crashs. Peut-etre en planifiant l'exécution
      du script quelques secondes après la fermeture normale de l'application.
"""
